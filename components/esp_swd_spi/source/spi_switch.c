...
void DAP_SPI_Init()
{
    ...
    // We will use IO_MUX to get the maximum speed.
    gpio_iomux_input(GPIO_NUM_12, FUNC_GPIO12_FSPICLK, FSPICLK_IN_IDX);
    gpio_iomux_output(GPIO_NUM_12, FUNC_GPIO12_FSPICLK);
...
__FORCEINLINE void DAP_SPI_Release()
{
    gpio_iomux_input(GPIO_NUM_12, FUNC_GPIO12_GPIO12, SIG_GPIO_OUT_IDX);
    gpio_iomux_output(GPIO_NUM_12, FUNC_GPIO12_GPIO12);
}
#endif
